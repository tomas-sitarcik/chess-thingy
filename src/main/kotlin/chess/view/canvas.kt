...
fun drawBoardBackground(view: MainView) {
...
fun highlightSquare(canvas: Canvas, coords: IntArray, highlightWidth: Int = 3, view: MainView) {
...
fun fillSquare(canvas: Canvas, coords: IntArray, highlightColor: Color, view: MainView) {
...
fun fillMoves(moves: Array<out IntArray>?, view: MainView) {

    if (moves != null) {
        for (move in moves) {
            fillSquare(view.moveHighlightCanvas, move, Color.rgb(0, 255, 125, 0.5), view)
        }
    }
...
fun drawPieces(board: Array<Array<Piece?>>, view: MainView) {
